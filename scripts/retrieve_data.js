function retrieve_data() {
    ...
    var pastYear = year - 10


    var url = "http://api.worldbank.org/v2/country?format=json&per_page=300"
    console.log(url)

    d3.json(url, function(countries_json) {
        ...
        countries_json[1].forEach(element => {
            if (countries.includes(element.id)) {
        ...
        var url2 = "https://api.worldbank.org/v2/country/" + countries_2 + "/indicator/GC.DOD.TOTL.GD.ZS?source=2&format=json&per_page=3000&date=1900:2022"
        console.log(url2)
